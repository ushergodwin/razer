                    ...
                    <div class="col-md-12 col-lg-7 col-xl-7">
                        ...
                        <form action="<?php echo e(url('home/register')); ?>" method="post" id="accountForm">
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" id="register-btn" class="btn btn-info w-100">CREATE ACCOUNT</button><br/>
...
<?php echo $__env->make('partials.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\yosil\app\views/account.blade.php ENDPATH**/ ?>