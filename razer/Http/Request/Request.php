<?php
namespace Razer\Http\Request;

use stdClass;
use Razer\Http\CRSF\CRSF;
use Razer\Http\Validate\Validate;
...
class Request {
     ...
     *
     * @param array $rules
     * @return \Razer\Http\Validate\Validate
     */
    ...
    /**
     * Retreive a file from a request
     *
     * @param string $key
