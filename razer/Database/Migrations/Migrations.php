<?php
namespace Razer\Database\Migrations;
...
use PDO;
use PDOException;
use Razer\Database\Schema\ColumnDefination;
...
{   
    ...
    public static function makeMigration()
    {
        ...
        $code = "<?php\n";
        $code .= "use Razer\Database\Schema\BluePrint;\n";
        $code .= "use Razer\Database\Schema\Schema;\n";
        $code .= "\n\n class " . $class . "\n { \n";
        $code .= "\t\t/**\n\t\t* Run the Migrations\n\t\t*\n\t\t* @return void\n\t\t*/ \n\t\t";
